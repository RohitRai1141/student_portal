...
if(isset($_POST['submit'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
            ...
            // Insert into news table (adjust table name as needed)
            $sql = "INSERT INTO news (file_name, uploaded_on, descc, link) VALUES ('$original_filename', '$current_date', '$description', '$link')";
            
            if(mysqli_query($con, $sql)) {
                $_SESSION['statusMsg'] = '<div class="alert alert-success"><strong>Success!</strong> News uploaded successfully.</div>';
            } else {
