...
if(isset($_POST['submit'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
            ...
            // Insert into result table with correct column names
            $sql = "INSERT INTO result (file_name, uploaded_on, descc, link) VALUES ('$original_filename', '$current_date', '$description', '')";
            
            if(mysqli_query($con, $sql)) {
                $_SESSION['statusMsg'] = '<div class="alert alert-success"><strong>Success!</strong> Result uploaded successfully.</div>';
            } else {
