...
if(isset($_POST['submit'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
            ...
            // Insert into materials table (adjust table name as needed)
            $sql = "INSERT INTO materials (file_name, uploaded_on, link) VALUES ('$original_filename', '$current_date', '$link')";
            
            if(mysqli_query($con, $sql)) {
                $_SESSION['statusMsg'] = '<div class="alert alert-success"><strong>Success!</strong> Material uploaded successfully.</div>';
            } else {
